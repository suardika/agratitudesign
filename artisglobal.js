...
var processHeaderMultipleBg = (function ($) {
    ...
    return (function (path) {
        ...
        var bgimages = "url('https://lh4.googleusercontent.com/-KIO6G4XYk58/UZBaxN3nxYI/AAAAAAAACzY/3bOnEj3c9C8/s2048/object2032779404.png'), ".split(",");
        var bgpositions = "28px 28px, ".split(",");
        ...
        header.css('background-image', "url('https://lh6.googleusercontent.com/-GU3kcX_7YJo/UZBawzjKVTI/AAAAAAAACzQ/RuT3S6RHo7g/s2048/header.jpg')".replace(/(url\(['"]?)/i, "$1" + path));
